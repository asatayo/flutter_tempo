...
class PaymentsMade extends StatelessWidget {
  ...
  const PaymentsMade({Key? key, required this.paymentsModel, required this.notifyParent})
      : super(key: key);
  @override
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            '${formater.format(double.parse(paymentsModel.amount!))}.00TZS',
                            textAlign: TextAlign.start,
                            style: const TextStyle(fontSize: 15),
                          ),
                        ],
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            fmt
                                .format(
                                    DateTime.parse(paymentsModel.entryDateTime!))
                                .toString(),
                            textAlign: TextAlign.start,
                            style: const TextStyle(fontSize: 15),
                          )
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            fmt
                                .format(
                                    DateTime.parse(paymentsModel.exitDateTime!))
                                .toString(),
                            textAlign: TextAlign.start,
                            style: const TextStyle(fontSize: 15),
                          )
