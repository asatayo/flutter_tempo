...
Widget checkbookSammary(BuildContext context, PaymentModel paymentModel) {
             ...
             Row(
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text(
                        'cooperate_number_short'.tr,
                        style: const TextStyle(fontSize: 16),
                      ),
                    ],
                  ),
                  Text(
                    paymentModel.cooperateNumber!,
                    style: const TextStyle(fontSize: 16),
                  ),
                ],
              ),
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                      '${formater.format(double.parse(paymentModel.amount!) * double.parse(paymentModel.roomsCount!))}.00TZS',
                      style: const TextStyle(
                          fontSize: 16, fontWeight: FontWeight.bold)),
                ],
              ),
