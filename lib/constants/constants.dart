...
const Color primaryColor = Color(0xfff46523);
const Color yellowColor = Color(0xffe4dcc9);
const Color whiteColor = Colors.white;
const Color blackColor = Colors.black54;
const Color greyColor = Colors.black54;
...
TextStyle bluek14MediumTextStyle = const TextStyle(
  color: Colors.blue,
  fontSize: 14,
  // fontWeight: FontWeight.w500,
);
...
TextStyle white10SemiBoldTextStyle = const TextStyle(
  color: Colors.white,
  fontSize: 10,
  // fontWeight: FontWeight.w600,
);
...
TextStyle premiumItemNameStyle = const TextStyle(
...
TextStyle premiumItemRatingStyle = const TextStyle(
  color: Colors.black54,
  fontSize: 10,
  overflow: TextOverflow.fade,
  fontWeight: FontWeight.w500,
